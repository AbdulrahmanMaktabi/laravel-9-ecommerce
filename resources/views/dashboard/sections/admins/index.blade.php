                    ...
                    <tbody>
                        @forelse ($admins as $admin)
                            <tr class="align-middle">
                                ...
                                <td>{{ $admin->name }}</td>
                                <td>{{ $admin->email }}</td>
                                <td>{{ $admin->phone ?? 'no phone' }}</td>
                                <td>{{ (bool) $admin->two_factor_secret ? 'yes' : 'no' }}</td>
                                <td>{{ $admin->last_active ? \Carbon\Carbon::parse($admin->last_active)->diffForHumans(now()) : 'no last active' }}
                                </td>
                                <td>
