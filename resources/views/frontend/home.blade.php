<x-frontend.layout title="Home page">
                            ...
                            <div class="col-xl-6 col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="wsus__pro_details_text">
                                    ...
                                    <div class="wsus_pro_det_color">
                                        <h5>color :</h5>
                                        <ul>
                                            <li><a class="blue" href="#"><i class="fas fa-check"></i></a>
                                            </li>
                                            <li><a class="orange" href="#"><i class="fas fa-check"></i></a>
                                            </li>
                                            <li><a class="yellow" href="#"><i class="fas fa-check"></i></a>
                                            </li>
                                            <li><a class="black" href="#"><i class="fas fa-check"></i></a>
                                            </li>
                                            <li><a class="red" href="#"><i class="fas fa-check"></i></a>
                                            </li>
                                        </ul>
                                    </div>
    ...
    <x-frontend.home-flash-sale :products="$products"></x-frontend.home-flash-sale>
