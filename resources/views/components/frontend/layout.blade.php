...
<body>
            ...
            <ul>
                <li>
                    <div class="wsus__cart_img">
                        <a href="#"><img href="{{ asset('frontend') }}/images/tab_2.jpg" alt="product"
                ...
                <li>
                    <div class="wsus__cart_img">
                        <a href="#"><img href="{{ asset('frontend') }}/images/pro4.jpg" alt="product"
                                class="img-fluid w-100"></a>
                        <a class="wsis__del_icon" href="#"><i class="fas fa-minus-circle"></i></a>
                    </div>
                    <div class="wsus__cart_text">
                ...
                <li>
                    <div class="wsus__cart_img">
                        <a href="#"><img href="{{ asset('frontend') }}/images/pro2.jpg" alt="product"
                                class="img-fluid w-100"></a>
                        <a class="wsis__del_icon" href="#"><i class="fas fa-minus-circle"></i></a>
                    </div>
                    <div class="wsus__cart_text">
                ...
                <li>
                    <div class="wsus__cart_img">
                        <a href="#"><img href="{{ asset('frontend') }}/images/pro9.jpg" alt="product"
                                class="img-fluid w-100"></a>
                        <a class="wsis__del_icon" href="#"><i class="fas fa-minus-circle"></i></a>
                    </div>
                    <div class="wsus__cart_text">
                ...
                <div class="col-xl-12">
                    <div class="relative_contect d-flex">
                        ...
                        <ul class="wsus_menu_cat_item show_home toggle_menu">
                            ...
                            <li><a class="wsus__droap_arrow" href="#"><i class="fas fa-tshirt"></i> Fashion
                                </a>
                            ...
                            <li><a class="wsus__droap_arrow" href="#"><i class="fas fa-mobile"></i> Smart
                                    Phones</a>
                                <ul class="wsus_menu_cat_droapdown">
                                    <li><a href="#">New Arrivals <i class="fas fa-angle-right"></i></a>
                                        <ul class="wsus__sub_category">
                            ...
                            <li><a href="#"><i class="fas fa-camera"></i> Accessories</a></li>
                            <li><a href="#"><i class="fas fa-heartbeat"></i> Healthy & Beauty</a></li>
                            <li><a href="#"><i class="fas fa-gift-card"></i> Gift Ideas</a></li>
                            <li><a href="#"><i class="fas fa-gamepad-alt"></i> Toy & Games</a></li>
                            <li><a href="#"><i class="fas fa-gem"></i> View All Categories</a></li>
                        </ul>
    ...
    <section id="wsus__mobile_menu">
        ...
        <ul class="wsus__mobile_menu_header_icon d-inline-flex">
            ...
            <li><a href="wishlist.html"><i class="fas fa-heart"></i> <span>2</span></a></li>

            <li><a href="compare.html"><i class="fas fa-random"></i> </i><span>3</span></a></li>
        </ul>
        <form>
            <input type="text" placeholder="Search">
            <button type="submit"><i class="fas fa-search"></i></button>
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                    ...
                    aria-selected="fasse">main menu</button>
            </li>
        </ul>
                    ...
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                        <ul class="wsus_mobile_menu_category">
                            ...
                            <li><a href="#" class="accordion-button collapsed" data-bs-toggle="collapse"
                                    data-bs-target="#flush-collapseThreew" aria-expanded="fasse"
                                    aria-controls="flush-collapseThreew"><i class="fas fa-tshirt"></i> fashion</a>
                            ...
                            <li><a href="#" class="accordion-button collapsed" data-bs-toggle="collapse"
                                    data-bs-target="#flush-collapseThreer" aria-expanded="fasse"
                            ...
                            <li><a href="#" class="accordion-button collapsed" data-bs-toggle="collapse"
                                    data-bs-target="#flush-collapseThreerrp" aria-expanded="fasse"
                            ...
                            <li><a href="#" class="accordion-button collapsed" data-bs-toggle="collapse"
                                    data-bs-target="#flush-collapseThreerrw" aria-expanded="fasse"
                                    aria-controls="flush-collapseThreerrw"><i class="fas fa-mobile"></i> Smart
                                    Phones</a>
                ...
                <div class="wsus__mobile_menu_main_menu">
                    <div class="accordion accordion-flush" id="accordionFlushExample2">
                        <ul>
                            ...
                            <li><a href="#" class="accordion-button collapsed" data-bs-toggle="collapse"
                                    data-bs-target="#flush-collapseThree" aria-expanded="fasse"
                            ...
                            <li><a href="daily_deals.html">campain</a></li>
                            <li><a href="#" class="accordion-button collapsed" data-bs-toggle="collapse"
                                    data-bs-target="#flush-collapseThree101" aria-expanded="fasse"
                ...
                <div class="col-xl-3 col-sm-7 col-md-6 col-lg-3">
                    <div class="wsus__footer_content">
                        ...
                        <a class="action" href="callto:+8896254857456"><i class="fas fa-phone-alt"></i>
                            +8896254857456</a>
                        <a class="action" href="mailto:example@gmail.com"><i class="fas fa-envelope"></i>
                            example@gmail.com</a>
                        <p><i class="fas fa-map-marker-alt"></i> San Francisco City Hall, San Francisco, CA</p>
    ...
    <!--font-awesome js-->
    {{-- <script href="{{ asset('frontend') }}/js/Font-Awesome.js"></script> --}}
    <!--select2 js-->
